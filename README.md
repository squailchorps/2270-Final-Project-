...
#### 3. Quadrant and Two Dimensional Math:
One of my biggest hiccups as I want was trying to visualize spatial things inside of code. The advice I was given was to draw it out, which did help! However, coming from a visual degree to begin with proved to be more of a burden than a boon. I spent a lot of time visualizing first *in my head* which resulted in a lot of headache and confusion. At this point, I was still lost on how to even implement the data structure, let alone *utilize two dimensions with numbers only*. The advice given before was from our previous homeworks, darwing things out! While I was able to get through and now can depict the spacing in my mind, it took a long time to solidify. 
...
Quad trees focus heavily on positional data. This proved to be difficult to tackle at first, as mentioned above, but clicked in after some playing around and visualizing it. While it started out as a massive burden, it did turn out to become a huge success for myself! I was working within what was originally just code and index’s. Adding in two-dimensional data was an interesting challenge that did result in me starting to deeply understand struct and classes! This also led to better understanding of geometry, although I still feel a bit rusty. 
